...
const TRUSTED = [
  { name: "HDFC Bank", sub: "Mumbai" },
  { name: "Infosys", sub: "Bengaluru" },
  { name: "Tata Consultancy", sub: "Services" },
  { name: "Reliance Jio", sub: "Navi Mumbai" },
  { name: "Flipkart", sub: "Bengaluru" },
  { name: "Zerodha", sub: "Est. 2010" },
];
    ...
    <div className="min-h-screen w-full bg-bone text-fg2">
        ...
        <div className="relative mx-auto grid max-w-[1240px] items-center gap-12 px-6 py-20 md:grid-cols-[1.05fr_1fr] md:gap-16 md:px-10 md:py-28">
          <div>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              ...
              <span className="text-[13px] text-fg3">14-day trial · Deploys in your cloud</span>
            </div>
          </div>
      ...
      <section className="border-y bg-bone-50" style={{ borderColor: "var(--border)" }}>
        <div className="mx-auto max-w-[1240px] px-6 py-10 md:px-10">
          <div className="text-center text-[12px] tracking-[-0.005em] text-fg3">
            Trusted by security teams protecting <span className="text-fg1 font-medium">2.4M endpoints</span>
          </div>
      ...
      >
        <div className="mx-auto max-w-[1240px] px-6 py-24 text-center md:px-10 md:py-32">
          ...
          >
            14-day trial. No card required. Connects to your SIEM, EDR, and cloud in minutes.
          </p>
      ...
      >
        <div className="mx-auto grid max-w-[1240px] gap-10 px-6 py-14 md:grid-cols-[1.6fr_1fr_1fr_1fr_1fr] md:px-10">
          ...
          {[
            { h: "Product", items: ["Triage", "Investigation", "Response", "Integrations", "Changelog"] },
            { h: "Solutions", items: ["SOC teams", "MSSPs", "Cloud security", "Identity", "Incident response"] },
