 ...
 * Matches the Alertwise design-system spec without adding the
...
export function AlertTriangle({ size = 18, className, strokeWidth = 1.5 }: Props) {
  return (
    <svg {...base(size, strokeWidth, className)}>
...
export function Zap({ size = 18, className, strokeWidth = 1.5 }: Props) {
  return (
    <svg {...base(size, strokeWidth, className)}>
